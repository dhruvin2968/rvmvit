...
const FeaturedEvent = () => {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-Redd/10 to-orange-500/10">
      ...
      <div className="relative p-8 md:p-12 flex flex-col md:flex-row gap-8">
        <div className="flex-1">
          <div className="flex items-center gap-2 text-Redd mb-4">
            <span className="px-3 py-1 rounded-full bg-Redd/20 text-md font-semibold">
              Featured Event
            </span>
          </div>
        ...
        <div className="flex flex-col justify-center">
          <button className="bg-gradient-to-r from-Redd to-orange-500 text-white px-8 py-3 rounded-lg hover:from-Redd hover:to-orange-600 transition-all transform hover:scale-105">
            Register Now
          </button>
        </div>
      </div>
